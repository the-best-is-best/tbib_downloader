...
void main() {
  final TbibDownloaderPlatform initialPlatform = TbibDownloaderPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    TbibDownloader tbibDownloaderPlugin = TbibDownloader();
    MockTbibDownloaderPlatform fakePlatform = MockTbibDownloaderPlatform();
    TbibDownloaderPlatform.instance = fakePlatform;

    expect(await tbibDownloaderPlugin.getPlatformVersion(), '42');
  });
}
